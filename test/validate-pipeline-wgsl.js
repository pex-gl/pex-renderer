...
const postProcessingVariants = [
  ...
  { name: "smaa edges [luma + predication]", shader: postProcessing.smaaEdgesShader, defines: new Set(["USE_SMAA_PREDICATION"]) },
  { name: "smaa edges [color + predication]", shader: postProcessing.smaaEdgesShader, defines: new Set(["SMAA_EDGES_COLOR", "USE_SMAA_PREDICATION"]) },
  ...
  { name: "smaa blend [reprojection]", shader: postProcessing.smaaBlendShader, defines: new Set(["USE_SMAA_REPROJECTION"]) },
  { name: "smaa resolve", shader: postProcessing.smaaResolveShader, defines: new Set() },
  { name: "smaa resolve [reprojection]", shader: postProcessing.smaaResolveShader, defines: new Set(["USE_SMAA_REPROJECTION"]) },
  ...
  { name: "motionBlur tileMaxX", shader: postProcessing.motionBlurTileMaxXShader, defines: new Set() },
  { name: "motionBlur tileMaxY", shader: postProcessing.motionBlurTileMaxYShader, defines: new Set() },
  { name: "motionBlur neighborMax", shader: postProcessing.motionBlurNeighborMaxShader, defines: new Set() },
  { name: "motionBlur", shader: postProcessing.motionBlurShader, defines: new Set() },
