...
* add dof post filter ([6901d88](https://github.com/pex-gl/pex-renderer/commit/6901d881d4f111ca0aeba09042cd37d5db977a76))
* add missing depthCompare to standard renderer ([56718e0](https://github.com/pex-gl/pex-renderer/commit/56718e0f3032d4818394e2c99be69faebcc282cb))
* add missing line in camera frustum ([6bdae9f](https://github.com/pex-gl/pex-renderer/commit/6bdae9f36787855d580ba20b6cc5b1fc00dccb9d))
* camera panning ([6d8c25f](https://github.com/pex-gl/pex-renderer/commit/6d8c25fdc2ce5d177df55ce9cf53e9b733d2637e))
* correct order of post-processing effect ([840cb9b](https://github.com/pex-gl/pex-renderer/commit/840cb9b116e401f83ac6f7d29991926ace88832d))
* correct reflection probe rotation ([21e6cae](https://github.com/pex-gl/pex-renderer/commit/21e6cae8351f036c22b38d1561886460a7895b88))
* correct specular textures handling ([37762af](https://github.com/pex-gl/pex-renderer/commit/37762af9b101dc6cf50029db5b93008acaac66b9))
* correct viewport for mip passes ([af0ffb1](https://github.com/pex-gl/pex-renderer/commit/af0ffb15711677e52d4917d8fa5e8a762d656fe2))
* derive uPostProcessing from describe(source)/describe(target) + add sourceTexelSize (for correct bloom filter tap) + dynamic bloom levels + handle opacity ([1a3f907](https://github.com/pex-gl/pex-renderer/commit/1a3f90784832b2100eb79e653c0bba91de7f0dcf))
* handle object as texture ([3c2a866](https://github.com/pex-gl/pex-renderer/commit/3c2a86629ee3125ba0a03617c2224b301ecf7fd4))
* make sky linear hdr + tonemap in blit ([25423a0](https://github.com/pex-gl/pex-renderer/commit/25423a0501f94d6d32d1130cb7fdb341e8b19b43))
* make sure fragment [@locations](https://github.com/locations) and pass attachments are in sync ([d384903](https://github.com/pex-gl/pex-renderer/commit/d38490386f0465368d69a9dd2c0b17270f36df49))
* pass view-space normal to getClearCoatNormal ([aaee505](https://github.com/pex-gl/pex-renderer/commit/aaee5056f385446180ec0946d9153d11e3f26906))
* pipeline variant cache + add debugRender guard ([8cbe86c](https://github.com/pex-gl/pex-renderer/commit/8cbe86c573a4beccee9350282e2c2fdd41ef508a))
* port all render-pipeline remaining passes ([a21633b](https://github.com/pex-gl/pex-renderer/commit/a21633b901c41010733cf241f123b745ec43d9bf))
* rebake reflection probe on exposure change ([7a5e593](https://github.com/pex-gl/pex-renderer/commit/7a5e59349e32433383d7927e4e5d9ee8f22da5c3))
* remove TAA flickering with DoF ([59c6365](https://github.com/pex-gl/pex-renderer/commit/59c636524484779a9c6cc33fd765cb10b280fe08))
* scope shadows per layer ([524b9e8](https://github.com/pex-gl/pex-renderer/commit/524b9e85a1e5d96ed4a8cf976db242c63ce50cf9))
* update radiusUv and bias for PCSS lights in standard + add back area lights ([8aa9f12](https://github.com/pex-gl/pex-renderer/commit/8aa9f12ad387e90798e7ecaa6ea8fd193cf37b6d))
* update ssao multiBounce "analytic" vs. "screen-space" ([ff8be69](https://github.com/pex-gl/pex-renderer/commit/ff8be696c5193606dd578868788ca8587cf19eb9))
* upgrade dof ([82cda4d](https://github.com/pex-gl/pex-renderer/commit/82cda4d2f83929210062887bed78b793dc169ee8))
* use entity modelMatrix instead of reflection probe rotation + fix prebaked specular texture usage, mip size and flip ([f2e1042](https://github.com/pex-gl/pex-renderer/commit/f2e1042c0157633b318f690273c50dd66025f4e7))
* use joints type from glTF + fix draco joints decoding ([78dad95](https://github.com/pex-gl/pex-renderer/commit/78dad95ca9c29397a28d752df9637fe365ca5d12))
* use outputs keys for pipeline variants ([27911f0](https://github.com/pex-gl/pex-renderer/commit/27911f0cf731e2c26b7692079a43e08f0c2304ee))
* use render pipeline fullscreen triangle in post-processing ([b7e1848](https://github.com/pex-gl/pex-renderer/commit/b7e18487146f6076e73aa797db5b885e33800c7c))


### Features

* add all standard material properties with feature flags ([29cada9](https://github.com/pex-gl/pex-renderer/commit/29cada97f6fcb7d91c47e7e3996f908dee7f50cb))
* add declareFullscreenPass post-processing helper for frameGraph pass hooks ([f087883](https://github.com/pex-gl/pex-renderer/commit/f08788351ae332b4947a1042024ac27e606f527a))
* add disocclusion rejection via previous-frame depth ([537786e](https://github.com/pex-gl/pex-renderer/commit/537786eba2ff97fbe7d61bcb82f2b3d11d6e78e8))
* add frame graph ([17fa918](https://github.com/pex-gl/pex-renderer/commit/17fa918d2c9c527ad9c43bcee0fce3071becbd04))
* add frame graph afterPass for injection + expose render textures on frameGraph.blackboard ([0d0c3b4](https://github.com/pex-gl/pex-renderer/commit/0d0c3b4e94e8ef053004d674f2fb52f2162b48c9))
* add glTF loader ([89ec63c](https://github.com/pex-gl/pex-renderer/commit/89ec63cb803a69f531be5b9cd4d9d266d92e6635))
* add hdr loader ([8dbbe83](https://github.com/pex-gl/pex-renderer/commit/8dbbe832f93c058da7f55d61e3c85f6bf012a91a))
* add ktx2/basis support ([4ab77a3](https://github.com/pex-gl/pex-renderer/commit/4ab77a3f322dc19cef0026f3055d9e531124fd51))
* add lens flare ([1ba16dd](https://github.com/pex-gl/pex-renderer/commit/1ba16dda420c4d1106fea8b4e5dec12aaa46c449))
* add material depthBias/depthBiasSlopeScale/depthBiasClamp for fighting z-fighting ([57d5c06](https://github.com/pex-gl/pex-renderer/commit/57d5c06e8e8abd4f1c283dbdcf93ef3636c06fb4))
* add motion blur ([88d7b2f](https://github.com/pex-gl/pex-renderer/commit/88d7b2ff32c96ade566bc0601257bd11e9b220f2))
* add MSAA depthResolve (wip) ([25d8860](https://github.com/pex-gl/pex-renderer/commit/25d8860e0458fe64fd21bb51d8e0e72cb72dfcbf))
* add pipeline shaders ([0f89a27](https://github.com/pex-gl/pex-renderer/commit/0f89a277dddf2835ce7ab0d1fd7f9d8d17daa767))
* add prepass for ao ([d61b553](https://github.com/pex-gl/pex-renderer/commit/d61b553731d7083fab56fd57d3436d929c60c190))
* add register to inspection ([8c90b08](https://github.com/pex-gl/pex-renderer/commit/8c90b0805a1d125498222a1268fadc8c425cecf7))
* add resetTemporal to camera system for jump cuts ([febfb81](https://github.com/pex-gl/pex-renderer/commit/febfb815e8930152bdd6937bde1a42baa9af792c))
* add sharpen pass for TAA ([c570698](https://github.com/pex-gl/pex-renderer/commit/c570698eb00ceab9d0e08bbe1894035468a2c51f))
* add skybox backgroundBlur as roughness level ([a474d90](https://github.com/pex-gl/pex-renderer/commit/a474d904ba579e8712577ffdec1a0037b9e62c62))
* add soft knee + make bloom run at half res ([326192e](https://github.com/pex-gl/pex-renderer/commit/326192efe3c7a9b8abac5301b3f0059935e1b0a0))
* add standard renderer with shadow maps ([046b6d0](https://github.com/pex-gl/pex-renderer/commit/046b6d098ee29550e99f3cc2c6b156a794c8dd81))
* add support for custom samplers in material textures ([a9e07c6](https://github.com/pex-gl/pex-renderer/commit/a9e07c6fb4a45c664653d631dc2ab85140210560))
* add support for responsiveAA in TAA ([429e2c9](https://github.com/pex-gl/pex-renderer/commit/429e2c94a53dc1fae66855917447a120abed8319))
* add TAA pass ([b6781a1](https://github.com/pex-gl/pex-renderer/commit/b6781a16497410f8dc4bf0426d2b0ed7627ce59c))
* add velocity output for TAA ([8a1b6db](https://github.com/pex-gl/pex-renderer/commit/8a1b6db1d7fbf9c04b8bf4b3356f61d66120e94a))
* allow pre-baked textures in reflection probe + add roughnessLevels/rotation/intensity ([a928860](https://github.com/pex-gl/pex-renderer/commit/a928860bc9646a2a743729b7a53da8a6d9ae1a49))
* bring back helpers ([b5c4960](https://github.com/pex-gl/pex-renderer/commit/b5c49601f92afc7a1735963c00f9f40c4e127cab))
* decouple transmission from light probe ([c1e7c62](https://github.com/pex-gl/pex-renderer/commit/c1e7c623a477d45846b2e60c2a6e2a5bd5d673f4))
* default ssao multiBounce to analytic + port ao example ([e251253](https://github.com/pex-gl/pex-renderer/commit/e2512536bddd9b24ff3bca5b8970a9c82e9fe4b9))
* expose declareFullscreenPass ([c6dda66](https://github.com/pex-gl/pex-renderer/commit/c6dda66ae54a7fd6aa16c4b571e492ca77cdb10e))
* fix all types ([d473585](https://github.com/pex-gl/pex-renderer/commit/d473585cc44b59c5e4a9c5547bb07d9a6f88a406))
* glTF + WebGPU naming alignment ([6f01866](https://github.com/pex-gl/pex-renderer/commit/6f0186639b1d4ba78b629e7e9c24a7057d59aeef))
* guard against reusing prebaked reflection probe cache resources in the bake path ([91e5464](https://github.com/pex-gl/pex-renderer/commit/91e54642f3f03dc86b8c4cfc0abd5077f511ad3c))
* handle skin, morph and instancing share for TAA ([8274b89](https://github.com/pex-gl/pex-renderer/commit/8274b891a7e03ad003e994e246dc210ebd6e3b54))
* make vertex output location contiguous ([49be95e](https://github.com/pex-gl/pex-renderer/commit/49be95e9a91e5a02b1137287adaec4ff41d72aa2))
* mask out the analytical sun disc for sh irradiance ([4225d8b](https://github.com/pex-gl/pex-renderer/commit/4225d8bb88036297494e54c05173365ec5df5636))
* move skybox and reflection probe to frame graph ([fa48c29](https://github.com/pex-gl/pex-renderer/commit/fa48c290d9d9d018e01cdf0a069676895782793f))
* move to shadow bucket and layer ([2918db7](https://github.com/pex-gl/pex-renderer/commit/2918db70924a777021c2fc1eca01de1df98e9b41))
* port basic rendering to pex-gpu and WGSL ([44d9336](https://github.com/pex-gl/pex-renderer/commit/44d93360000c6c3fcc7fa3379a4426cfeb01f67d))
* port helper example ([a62f532](https://github.com/pex-gl/pex-renderer/commit/a62f532899f09dd0e2a1f9898a0196b88a4fe56b))
* port line renderer ([6899200](https://github.com/pex-gl/pex-renderer/commit/6899200dfb67540d3d004a507abb6310a49c38f3))
* port post processing to frame graph (wip) ([e1f0bb0](https://github.com/pex-gl/pex-renderer/commit/e1f0bb02f2cf82cd8b9dc558d987579fe3ed98eb))
* port reflection probe to L2 SH + prefiltered GGX mip chain in a native textureCube + handle energy compensation ([0bfa64b](https://github.com/pex-gl/pex-renderer/commit/0bfa64ba7cf71d1cfb75bf4896e58e88fc421803))
* port renderer hooks ([7ed60de](https://github.com/pex-gl/pex-renderer/commit/7ed60de6c97b878ce14339a22887bcafccb52929))
* port skybox system and renderer ([c0c3ac1](https://github.com/pex-gl/pex-renderer/commit/c0c3ac15387b16fa60a0065286360a0245c42aed))
* remove indexed color attachments in favour of named render textures ([e3d11c6](https://github.com/pex-gl/pex-renderer/commit/e3d11c645474d7ba711d07215bd3cf9ab4227830))
* remove max light count cap ([114779d](https://github.com/pex-gl/pex-renderer/commit/114779dc4be778be61e6961c06c2a1c45b98af11))
* remove PostProcessingEffect custom schema in favour of FrameGraph style declare with pass ([77375f3](https://github.com/pex-gl/pex-renderer/commit/77375f3e2a31bee6e856121793086cae4a9b3cb7))
* remove reflection probe size ([b44c89e](https://github.com/pex-gl/pex-renderer/commit/b44c89e8b5e70edf103d641816e7d4bfda35cc95))
* resolve emissive temporally for TAA ([dd9d9c3](https://github.com/pex-gl/pex-renderer/commit/dd9d9c318c5214660bfa505e9b2d318eaf24a150))
* uniformise reflection probe and skybox rotation ([c4432c5](https://github.com/pex-gl/pex-renderer/commit/c4432c5f091a54df5fcc92dc749c66ff88d25400))
* upgrade depth of field ([f1a4613](https://github.com/pex-gl/pex-renderer/commit/f1a4613da9e58ebc771060ddbc17cce025390572))
* upgrade GTAO ([ae19daf](https://github.com/pex-gl/pex-renderer/commit/ae19daff1c5a6e80aa731da2532ad0fae4721862))
* upgrade SAO ([0f3122a](https://github.com/pex-gl/pex-renderer/commit/0f3122a9bb868cedffe287a7cdf8faf9ecde03e8))
* use clamp addressModeV for envSampler ([060825d](https://github.com/pex-gl/pex-renderer/commit/060825d32f29d4fb74f671be5b962a3371159334))
* use pex-gpu generateMipmaps for grab pass ([7106bb5](https://github.com/pex-gl/pex-renderer/commit/7106bb56747bc49674909305e186c7df5c7a590c))
* use physical light units ([5673636](https://github.com/pex-gl/pex-renderer/commit/5673636de7e6df13035efdcb4702c51f067cb7b7))
* use physical luminance values ([670e371](https://github.com/pex-gl/pex-renderer/commit/670e37117120691d4024198fa8ad19b9b4ae8376))
* use storage declaration for lights ([c4154d4](https://github.com/pex-gl/pex-renderer/commit/c4154d49de37261355f0d704102d2970815bc621))
