...
function FlyControls(opts) {
  ...
  this.flySpeed = 0.1
  this.sensitivityX = 0.005
  this.sensitivityY = 0.005
  this.releaseOnMouseUp = false
...
FlyControls.prototype.setup = function() {
  ...
  function onMouseMove(e) {
    ...
    if (document.pointerLockElement) {
      ...
      quat.mult(
        flycontrols.currentYaw,
        quat.fromAxisAngle(
          quat.create(),
          [0, 1, 0],
          -movementX * flycontrols.sensitivityX
        )
      )
      quat.mult(
        flycontrols.currentPitch,
        quat.fromAxisAngle(
          quat.create(),
          [1, 0, 0],
          -movementY * flycontrols.sensitivityY
        )
      )

      let newRot = quat.mult(
        quat.mult([0, 0, 0, 1], flycontrols.currentYaw),
        flycontrols.currentPitch
      )
  ...
  function onMouseUp(e) {
    if (!flycontrols.enabled) return
    if (flycontrols.releaseOnMouseUp) {
  ...
  function onKeyDown(e) {
    ...
    switch (e.keyCode) {
      case 38: /*up*/
      case 87:
        /*W*/ flycontrols.moveForward = true
        break

      case 37: /*left*/
      case 65:
        /*A*/ flycontrols.moveLeft = true
        break

      case 40: /*down*/
      case 83:
        /*S*/ flycontrols.moveBackward = true
        break

      case 39: /*right*/
      case 68:
        /*D*/ flycontrols.moveRight = true
        break

      case 32:
        /*space*/ flycontrols.moveUp = true
        break

      case 16:
        /*shift*/ flycontrols.moveDown = true
        break
    }
  }
  ...
  function onKeyUp(e) {
    ...
    switch (e.keyCode) {
      case 38: /*up*/
      case 87:
        /*W*/ flycontrols.moveForward = false
        break

      case 37: /*left*/
      case 65:
        /*A*/ flycontrols.moveLeft = false
        break

      case 40: /*down*/
      case 83:
        /*S*/ flycontrols.moveBackward = false
        break

      case 39: /*right*/
      case 68:
        /*D*/ flycontrols.moveRight = false
        break

      case 32:
        /*space*/ flycontrols.moveUp = false
        break

      case 16:
        /*shift*/ flycontrols.moveDown = false
        break
    }
  }
